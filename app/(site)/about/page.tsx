    ...
    <main className="py-16">
      <Container>
        <div className="max-w-3xl">
          <p className="text-sm font-medium uppercase tracking-widest text-emerald-400/90">Pahadis at heart</p>
          <h1 className="mt-2 text-4xl font-bold text-white md:text-5xl">About Nirvana Treks & Tours</h1>
          <p className="mt-6 text-lg leading-relaxed text-white/90">
            You know that one bro who always knows a spot? We&rsquo;re a bunch of Himachali locals
            who turned &ldquo;bhai, I know a spot&rdquo; into a travel company. Born and raised in
            these valleys, we run the treks we grew up on, and we take you to the corners the tour
            buses never find.
          </p>
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: Globe2, title: "Local crew", desc: "Born-and-raised Himachalis running the trips on home turf" },
